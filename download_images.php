...
function downloadImage($url, $filename) {
    try {
        ...
        if ($contents && $httpCode === 200) {
            $result = Storage::disk('public')->put($filename, $contents);
            if ($result) {
...
$stores = [
    ...
    [
        ...
        'cover' => 'https://images.unsplash.com/photo-1626082927389-6cd4c1f1c8b0?w=800&h=400&fit=crop&q=80'
    ],
    [
        'name' => 'Popeyes',
        'logo' => 'https://images.unsplash.com/photo-1626082927389-6cd4c1f1c8b0?w=200&h=200&fit=crop&q=80',
...
foreach ($categories as $category) {
    $path = "stores/categories/" . Str::slug($category['name']) . ".jpg";
