            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="section_title mb-60 post_category_widget text-center" style="display: ruby-text;">
                        ...
                        <li>/</li>
                        <li><a href="#" class='widget_title section-active'>Categories</a></li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 mb-4">
                <div class="text-center">
                    <a href="{{ route('vendor.categories.create') }}" class="boxed-btn5" style="padding: 16px 100px;">
                        Create New Category
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h3 class="mb-4">Your Categories</h3>
